...
def arguments():
    ...
    parser_adapt = subparsers.add_parser("retrain", help="adapt a model (run 'retrain -h' for more details)")
...
def train(args):
    ...
    with keras.utils.CustomObjectScope({L1L2_m.__name__: L1L2_m}):
        ...
        predictions = keras.layers.Dense(len(classes), activation="softmax", kernel_regularizer=L1L2_m(l1=0, l2=0, prior_shape=(DENSE_DIM, len(classes))))(dropout01)
